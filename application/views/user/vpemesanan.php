			...
			<div id="cuponslide">
				...
				<form class="row contact_form" action="#" method="post" novalidate="novalidate">
					...
					<div class="col-md-6 form-group">
						<button type="submit" value="submit" class="button_cupon">Pakai</button>
					</div>
				</form>
			</div>
		</div>
		<div class="billing_details">
			<div class="row">
				<div class="col-lg-8">
					...
					<form class="row contact_form" action="#" method="post" novalidate="novalidate">
						<div class="col-md-6 form-group p_star">
							<input type="text" class="form-control" id="first" name="inputnama" placeholder="Nama Lengkap*"
							<?php if($kondisi == 1) {
						...
						<div class="col-md-6 form-group p_star">
							<input type="text" class="form-control" id="last" name="inputnomor" placeholder="No HP / Whatsapp*"
							<?php if($kondisi == 1) {
						...
						<div class="col-md-12 form-group">
							<input type="text" class="form-control" id="company" name="inputemail" placeholder="Email*"
							<?php if($kondisi == 1) {
						...
						<div class="col-md-12 form-group mb-0">
							...
							<div id="transfer" class="row hide">
								...
								<div class="col-md-12 form-group p_star">
									<input type="text" class="form-control" id="add1" name="add1" placeholder="Kode Pos*"
										<?php if($kondisi == 1) {
											echo'value="'.$alamat->kodepos.'"';
										}else{
											"";
										} ?>>
