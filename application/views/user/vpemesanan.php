			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="row contact_form" action="#" method="post" novalidate="novalidate">
						...
						<div class="col-md-6 form-group p_star">
							<input type="text" class="form-control" id="last" name="inputnomor" placeholder="No HP / Whatsapp*" <?php if ($kondisi == 1) {echo 'value="' . $alamat->nohp . '"';} else if ($kondisi == 2) {echo 'value="' . $user->no_hp . '"';} else {"";}?>>
							<span class="placeholder" data-placeholder="Last name"></span>
						</div>
						<div class="col-md-12 form-group">
							<input type="text" class="form-control" id="company" name="inputemail" placeholder="Email*" <?php if ($kondisi == 1) {echo 'value="' . $user->email . '"';} else if ($kondisi == 2) {echo 'value="' . $user->email . '"';} else {"";}?>>
						</div>
						<div class="col-md-12 form-group">
