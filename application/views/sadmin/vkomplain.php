                                ...
                                <tbody>
                                    ...
                                    foreach ($komplain as $a) { ?>
                                        <tr>
                                            ...
                                            <td><?= $a->no_transaksi; ?>&nbsp;
                                                <a href="<?= base_url('Sadmin/detailtransaksi/' . $a->no_transaksi) ?>" type="button" data-toggle="tooltip" class="mdi mdi-eye fa-lg text-warning" data-original-title="Detail Transaksi"></a>
                                            </td>
                                            <td><?= $a->no_pengaju; ?></td>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="<?= base_url('Sadmin/komplainselesai/' . $a->id_komplain) ?>" type="button" data-toggle="tooltip" title="" class="btn mb-1 btn-success text-white" data-original-title="Selesai">
