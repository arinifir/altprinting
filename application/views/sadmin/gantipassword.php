                                ...
                                <form action="" class="form-profile">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="password" name="pwlama" placeholder="Masukkan Password">
                                        </div>
                                        <div class="form-group">
                                            <label>Password Baru</label>
                                            <input type="text" class="form-control" id="password1" name="password1" placeholder="Masukkan Password">
                                        </div>
                                        <div class="form-group">
                                            <label>Konfirmasi Password</label>
                                            <input type="text" class="form-control" id="password2" name="password2" placeholder="Masukkan Password Kembali">
                                        </div>
                                    </div>
