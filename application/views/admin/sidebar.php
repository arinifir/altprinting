        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="<?= base_url('admin/Pelanggan/datapelanggan') ?>" aria-expanded="false">
                    <i class="mdi mdi-account-multiple"></i><span class="nav-text">Pelanggan</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Produk/dataproduk') ?>" aria-expanded="false">
                    <i class="mdi mdi-image-multiple"></i><span class="nav-text">Produk</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Kategori/datakategori') ?>" aria-expanded="false">
                    <i class="mdi mdi-shape"></i><span class="nav-text">Kategori</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Voucher/datavoucher') ?>" aria-expanded="false">
                    <i class="mdi mdi-ticket-percent"></i><span class="nav-text">Voucher</span>
                </a>
            </li>
            <li class="nav-label">Transaksi</li>
            <li>
                <a href="<?= base_url('admin/Admin/datatransaksi') ?>" aria-expanded="false">
                    <i class="mdi mdi-view-list"></i><span class="nav-text">Data Transaksi</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Admin/confirmbayar') ?>" aria-expanded="false">
                    <i class="mdi mdi-credit-card-check"></i><span class="nav-text">Konfirmasi Pembayaran</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Admin/antriankirim') ?>" aria-expanded="false">
                    <i class="mdi mdi-truck-fast"></i><span class="nav-text">Menunggu Pengiriman</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Admin/resikirim') ?>" aria-expanded="false">
                    <i class="mdi mdi-tag-text"></i><span class="nav-text">Resi Pengiriman</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Admin/transelesai') ?>" aria-expanded="false">
                    <i class="mdi mdi-check"></i><span class="nav-text">Selesai</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('admin/Admin/dataulasan') ?>" aria-expanded="false">
                    <i class="mdi mdi-comment"></i><span class="nav-text">Ulasan</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="<?= base_url('Admin/pembelian') ?>" aria-expanded="false">
                    <i class="mdi mdi-cart"></i><span class="nav-text">Pembelian</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url('Admin/riwayatpembelian') ?>" aria-expanded="false">
                    <i class="mdi mdi-history"></i><span class="nav-text">Riwayat Pembelian</span>
                </a>
            </li>
        </ul>
    </div>
