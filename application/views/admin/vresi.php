                            ...
                            <div class="modal fade" id="resi<?= $t->no_transaksi; ?>">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form class="form-valide" action="<?= base_url('admin/Transaksi/tambahresi') ?>" method="post">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <a href="<?= base_url('admin/Transaksi/resi/' . $t->no_transaksi); ?>" type="button" data-toggle="tooltip" title="" class="btn mb-1 btn-danger text-white" data-original-title="Dikemas">
                                                        Kirim Resi
                                                    </a>
                                                <?php } ?>
                                            </td>
