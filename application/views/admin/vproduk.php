                                ...
                                <tbody>
                                    ...
                                    foreach ($produk as $pr) { ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/Paket/lihatpaket/' . $pr->kd_produk); ?>" type="button" data-toggle="tooltip" title="" class="btn mb-1 btn-primary text-white" data-original-title="Lihat Paket">Paket
                                                </a>
                                            </td>
                                            <td><?= $pr->kd_produk; ?></td>
