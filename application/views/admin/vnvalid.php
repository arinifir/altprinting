                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="<?= base_url('admin/Transaksi/hapusorder/' . $t->no_transaksi) ?>" type="button" data-toggle="tooltip" class="btn mb-1 btn-danger text-white" data-original-title="Hapus Transaksi">
